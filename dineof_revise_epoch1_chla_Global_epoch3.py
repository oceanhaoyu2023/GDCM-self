...
model = generator(7)
model.to(device)
model.load_state_dict(torch.load('./Model_Train_Results/model_last_save_revise_epoch_3_back_chlor_global.pth',map_location=device)['model_state_dict'])
...
for ep in range(30):
    ...
    #                             for x_input_batch, mask_input_batch, x_target_batch, mask_target_batch in train_dataloader_2:
                                ...
                                outputs = model2(x_input, x_batch_decoder)
                                outputs = outputs.cpu().detach().numpy()
                ...
                if epoch_num % 500 == 0:
                    ...
                    }, save_dir + f"model_last_save_revise_epoch_3_back_chlor_global.pth")
